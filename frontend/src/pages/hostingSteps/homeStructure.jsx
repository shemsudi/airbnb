    ...
    <div className=" flex flex-col h-screen">
      ...
      <div className="border-t-4  w-full  sticky bottom-0 left-0 z-100 bg-white px-6  py-3 border-gray-200">
        <div className=" w-full flex justify-between items-center ">
          <button
            onClick={backToStructurePage}
            className="underline  transform active:scale-95 opacity-80 hover:opacity-100"
          >
            Back
          </button>
          <button
            onClick={NavigateToPrivacyTypePage}
            className="  rounded-lg transform active:scale-95  bg-black opacity-80 hover:opacity-100  text-white px-6 py-2 "
          >
            {" "}
            Next{" "}
          </button>
