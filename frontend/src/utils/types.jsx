...
const types = [
  ...
  { type: "Shepherd's hat", icon: <HouseIcon /> },
...
const amenitiesItems = [
  ...
  { type: "Free parking on premises", icon: <HouseIcon /> },
  { type: "Paid parking on premises", icon: <HouseIcon /> },
  { type: "Air conditioning", icon: <HouseIcon /> },
  { type: "Dedicated Workspace", icon: <HouseIcon /> },
];
...
const uniqueAmenitiesItems = [
  ...
  { type: "Outdoor dining area", icon: <HouseIcon /> },
  { type: "Fire pit", icon: <HouseIcon /> },
  { type: "Pool table", icon: <HouseIcon /> },
  { type: "Indoor fireplace", icon: <HouseIcon /> },
  { type: "Piano", icon: <HouseIcon /> },
  { type: "Exercise equipment", icon: <HouseIcon /> },
  { type: "Lake access", icon: <HouseIcon /> },
  { type: "Beach access", icon: <HouseIcon /> },
  { type: "Ski-in/Ski-out", icon: <HouseIcon /> },
  { type: "Outdoor shower", icon: <HouseIcon /> },
];

const safetyAmenitiesItems = [
  { type: "Smoke alarm", icon: <HouseIcon /> },
  { type: "First aid kit", icon: <HouseIcon /> },
